<template>
  ...
  >
    ...
    <el-table-column property="ctime" label="申请时间" width="180">
    </el-table-column>
    <el-table-column property="ftype" label="类型" width="120">
    </el-table-column>
    <el-table-column property="department_name" label="部门" width="120">
    </el-table-column>
    <el-table-column property="name" label="员工" width="120">
    </el-table-column>
    <el-table-column property="stime" label="起始时间" width="180">
    </el-table-column>
    <el-table-column property="etime" label="结束时间" width="180">
    </el-table-column>
...
export default {
    ...
    onSubmit(formName) {
      ...
      this.$refs[formName].validate(function (valid) {
        if (valid) {
          ...
          axios.post("http://localhost:8000/api/leave/audit", params).then(function (response) {
  ...
  mounted() {
    ...
    axios
      .get("http://localhost:8000/api/leave/list?eid=" + sessionStorage.eid)
